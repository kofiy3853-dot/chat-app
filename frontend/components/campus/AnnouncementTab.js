          ...
          <div className="bg-surface rounded-[2rem] border border-[var(--divider)] p-6 shadow-xl shadow-primary-500/5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                ...
                className="w-full py-4 bg-primary-600 text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-lg shadow-primary-600/30 active: disabled:opacity-30"
              >
              ...
              >
                {ann.imageUrl && (
                  <div className="h-48 w-full overflow-hidden">
                    <img src={ann.imageUrl} className="w-full h-full object-cover group-hover:" alt="" />
                  </div>
                )}
                <div className="p-6">
            ...
            <div className="relative w-full max-w-xl bg-surface rounded-t-[3rem] sm:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
               {selectedAnnouncement.imageUrl ? (
                  <div className="h-64 bg-surface-3 relative shrink-0">
                     ...
                     <button 
                       onClick={() => setSelectedAnnouncement(null)}
                       className="absolute top-6 right-6 p-2 bg-black/40 backdrop-blur-md text-white rounded-2xl hover:bg-black/60 shadow-xl"
                     >
               ...
               <div className="flex-1 overflow-y-auto px-8 py-10 custom-scrollbar">
                  ...
                  <div className="flex items-center space-x-4">
                     <button className="flex-1 py-4 bg-primary-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-primary-600/20 active:]">
                        Spread the word
                     </button>
                     {(currentUser?.id === selectedAnnouncement.userId || currentUser?.role === 'ADMIN') && (
                       <button 
                         ...
                         className="p-4 bg-red-50 text-red-500 rounded-2xl hover:bg-red-100 active:] border border-red-100"
                        >
