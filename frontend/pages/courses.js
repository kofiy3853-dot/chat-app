  ...
  return (
    <>
      ...
      <div className="max-w-xl mx-auto min-h-screen shadow-2xl flex flex-col relative overflow-hidden" style={{ backgroundColor: 'var(--bg-page)' }}>
        {/* Header - Royal Blue */}
        <header className="sticky top-0 z-30 bg-primary-600 px-4 pt-[max(env(safe-area-inset-top,0px),40px)] pb-4 shadow-md">
                  ...
                  {modalTab === 'JOIN' ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full bg-primary-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-primary-500/30 hover:bg-primary-700 active:"
                      >
                        Enroll Now
                      </button>
                    </form>
